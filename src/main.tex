...
\personalinfo{%
  ...
  \mailaddress{1bis chemin des violettes}
  \location{13105 Mimet}
  \printinfo{\faCalendar}{39 years old}
%  \homepage{}
%  \twitter{@damounet}
...
\cvevent{Technical Leader \par(Aircraft maintenance manuals management)}{Airbus - e-TechPub (Alten)}{Apr 2018 -- Ongoing}{Vitrolles}
\begin{itemize}
